...
# ───────────────────────────────────────────────────────────────────────────────
# 1b) SUPPRESSION DU WEBHOOK TELEGRAM (pour éviter tout conflit getUpdates)
# ───────────────────────────────────────────────────────────────────────────────
...
try:
    ...
    pass  # s’il n’y en a pas, on ignore
...
# Budget mensuel 10 € → conversion ETH
...
def safe_send(message: str):
    """
    Envoi direct via l’API HTTP Telegram, sans python-telegram-bot,
    pour éviter tout second getUpdates/webhook.
    """
...
def run_telegram_polling():
    # Un seul run_polling, avec drop_pending_updates pour purger l’historique
